...
class JoinClanEmbeds:
    ...
    async def get_join_clan_embed(user: discord.User) -> discord.Embed:
        ...
        embed.add_field(
            name="What content do you like to do?", value="``` ```", inline=False
        )
        embed.add_field(
            name="Why do you want to join our clan?", value="``` ```", inline=False
        )
    ...
    async def get_kitty_welcome_embed() -> discord.Embed:
        ...
        embed.set_image(
            url="https://media.discordapp.net/attachments/1135573799790723082/1157820557098762240/image.png?ex=678e32ac&is=678ce12c&hm=5e2fc063026002bc839906ce949019189b8d62c632e838e44e0fb2b3995a7ec1&=&format=webp&quality=lossless&width=1388&height=590"
        )

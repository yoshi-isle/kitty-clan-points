class ClanMember:
    def __init__(self, data: dict = None, discord_id: str = None, is_active: bool = False, points: int = 0, point_history: list = None, google_sheet_url: str = None, survey_q1: str = None, survey_q2: str = None, survey_q3: str = None, survey_q4: str = None):
        if data:
